export default function Interests() {
  return (
    <div className="h-[10vh] w-full overflow-hidden bg-rachelBlue flex justify-center items-center relative overflow-hidden">
      <div className="h-[8vh] w-full bg-rachelCream flex overflow-hidden space-x-16">
        ...
        <div
          className="flex items-center whitespace-nowrap text-rachelBlue text-lg flex space-x-16 animate-loop-scroll"
          aria-hidden="true"
        >
          <span className="text-3xl tracking-tighter font-extralight">
            <strong className="font-black">Machine</strong> Learning
